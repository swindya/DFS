...
if (!isset($_GET["pathku"])) {
	...
	$mypath=$_GET["pathku"];
//----------------------------------------------------
if (!isset($_GET["filenameku"])) {
	$myfile="";
}
else
	$myfile=$_GET["filenameku"];
//----------------------------------------------------
...
$a=0;
	...
	$replace_with=$mypath;
	//$replace_with="D:";
	replace_string_in_file($filename1, $string_to_replace, $replace_with);
?>

<script>
window.open("./filemanagerok/elfinder.php","_self");
</script>
