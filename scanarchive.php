...
.buttondown.icon span{
   padding-left: 10px;
   padding-right: 15px;
   background:url('./images/left1.png') no-repeat 0 -10px;

   }
.buttondown.icon.chat span {
...
.buttonup.icon span{
   padding-left: 10px;
   padding-right: 15px;
   background:url('./images/right1.png') no-repeat 0 -14px;

   }
.buttonup.icon.chat span {
   background-position: 0px -2px;
   }
</style>
<style>
...
var sFolderPath = "C:\\W04D";
//alert(sFolderPath);
	//if (!fso.FolderExists(sFolderPath)) {
		//alert("Folder does not exist!");
	//}
	
var sFileObj = new ActiveXObject("Scripting.FileSystemObject");
//var sFolderPath = "C:\\Temp\\t2";
if(!sFileObj.FolderExists(sFolderPath))
{
      alert('Folder does not exists');
}
alert("Bisa ?");
sFileObj.CreateFolder(sFolderPath);
...
function checkday()
{
	var myday = document.getElementsByName("tglhari")[0].value;
	if (myday<1 || myday>31)
	{
		alert("Data yg anda masukkan tidak valid. Ulangi dengan nilai 1 s/d 31");
		document.getElementsByName("tglhari")[0].value=1;
	}
}
</script>
<script>
function checkmonth()
{
	var mymonth = document.getElementsByName("tglbulan")[0].value;
	if (mymonth<1 || mymonth>12)
	{
		alert("Data yg anda masukkan tidak valid. Ulangi dengan nilai 1 s/d 12");
		document.getElementsByName("tglbulan")[0].value=1;
	}
}
</script>
<script>
function checkyear()
{
	var myyear = document.getElementsByName("tgltahun")[0].value;
	if (myyear<2000 || myyear>2200)
	{
		alert("Data yg anda masukkan tidak valid. Ulangi dengan nilai tahun (2000 s/d 2200");
		document.getElementsByName("tgltahun")[0].value=2010;
	}
}
</script>
<script>
function lesstgl()
{
	...
	var mymonth = document.getElementsByName("tglbulan")[0].value;
	var myyear = document.getElementsByName("tgltahun")[0].value;
	var dateku = myyear + "-" + mymonth + "-" + myday;
	var resultku = new Date(dateku);
	resultku.setDate(resultku.getDate()-1);
    document.getElementsByName("tglhari")[0].value=resultku.getDate();
	document.getElementsByName("tglbulan")[0].value=resultku.getMonth()+1;
	document.getElementsByName("tgltahun")[0].value=resultku.getFullYear();
	document.getElementsByName("barcodeno")[0].value="";
//alert(dateFormat(result,"dd") +  " " + dateFormat(result,"mm"));
}
</script>
<script>
function moretgl()
...
function managefile()
{
	...
	if (barcodeku==null || barcodeku.length<3)
	{
		alert("Masukkan nama dokumen dengan benar");
		return false;
	}
...
?>
			...
			<table align="center" style="text-align: left; margin-left: auto; margin-right: auto; margin-top: auto;" width="90%" border="0" cellspacing="0" cellpadding="0">
				<thead>
    				<tr height="30px">
    					<td style="padding-left: 0px; padding-top: auto; text-align: center;" width="30%">
						...
						<td style="padding-left: 0px; padding-top: auto; text-align: center;" width="30%">
    						<!--font face="arial" color="black" size="4"><b>DATE (tgl-bulan-tahun)</b></font-->
							<img style="padding-left: auto;" align="middle" src="./images/tglbulantahun.jpg" height="32px" width="210px">
    					</td>
    				</tr>
				...
				<tbody>
					<tr height="40px">
						...
						<td style="padding-left: 0px; text-align: center;">
 							<FONT face="arial" color="black" size="2">
							<b><input style="text-align:center;" id="jmlscan" name="jmlscan" class="textboxnarrow" type="text" maxlength="8" value="<?php echo $jmlscanku;?>" readonly></b>
							</FONT>
						</td>
						<td style="padding-left: auto; text-align: center; vertical-align: middle;">
							<FONT face="arial" color="black" size="2">
								<a class="buttondown icon chat" onclick="lesstgl(); return false;"><span></span></a> &nbsp;
								<input style="text-align:center;" id="tglhari" name="tglhari" class="textboxbul" maxlength="2" onchange="checkday();">&nbsp;
								<input style="text-align:center;" id="tglbulan" name="tglbulan" class="textboxbul" maxlength="2" onchange="checkmonth();">&nbsp;
								<input style="text-align:center;" id="tgltahun" name="tgltahun" class="textboxthn" maxlength="4" onchange="checkyear();">&nbsp;
								<a class="buttonup icon chat" onclick="moretgl(); return false;"><span></span></a>
							</FONT>
						</td>
					</tr>
					<tr height="40px">
