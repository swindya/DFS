...
//-------------------------------------------------
if (!isset($_POST["modelmesin12"])) {
	$modelmesin1=0;
}
else
	$modelmesin1=$_POST["modelmesin12"];
//-------------------------------------------------
if (!isset($_POST["modelmesin22"])) {
	$modelmesin2=0;
}
else
	$modelmesin2=$_POST["modelmesin22"];
//-------------------------------------------------
...
$sql0 = "SELECT * FROM tipemesin2 WHERE (tipemesin2='" . $modelmesin2 . "');";
$tipe = "tipemesin1";
...
//echo $row_cnt;
if ($row_cnt == 0) {
	$sql = "INSERT INTO tipemesin2(tipemesin1, tipemesin2, createduser, createddate) VALUES('" .
			$modelmesin1 . "','" . $modelmesin2 . "'," . $userid . ",now());";
//echo $sql . "<br>";
